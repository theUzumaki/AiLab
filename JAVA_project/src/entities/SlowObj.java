...
public class SlowObj extends StaticEntity {
	
	public SlowObj(int x, int y, int xoffset, int yoffset, int width, int heigth, int TILE, int selector) {
		super(x, y, xoffset, yoffset, width, heigth, TILE, selector, "slowobj");
	...
	protected void loadImages() {
		...
		try {
			sprites= new BufferedImage[] {
					...
					ImageIO.read(getClass().getResourceAsStream("/sprites/pond/pond.png")),
